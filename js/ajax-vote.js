			...
			success: function(result){
				if( result == "notfound" ) {
					...
					swal({
						...
						html: "<img src='https://cdn.wiput.me/acsp/" + id + ".jpg' style='max-height: 217px !important;'><br><br>เลขประจำตัว : " + id + "<br>ชื่อ : " + result + "<br><b>หากโหวตแล้วจะไม่สามารถแก้ไขข้อมูลได้</b>",
						type: "warning",
